...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'customers.customer': {
            ...
            'billing_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'to': "orm['common.Address']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
            'date_of_birth': ('django.db.models.fields.DateField', [], {'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'to': "orm['common.Address']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'to': "orm['common.Image']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'}),
            'shipping_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'to': "orm['common.Address']", 'null': 'True', 'related_name': "'+'", 'blank': 'True'})
        },
        'mailbox.message': {
            ...
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['customers.Customer']", 'related_name': "'mailbox_message_participants'"}),
