...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reply.notified'
        db.delete_column('mailbox_reply', 'notified')


    def backwards(self, orm):
        # Adding field 'Reply.notified'
        db.add_column('mailbox_reply', 'notified',
    ...
    models = {
        ...
        'mailbox.message': {
            ...
            'participants_notified': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'mailbox_message_participants_notified'", 'symmetrical': 'False', 'to': "orm['customers.Customer']"}),
            'participants_read': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'mailbox_message_participants_read'", 'symmetrical': 'False', 'to': "orm['customers.Customer']"}),
