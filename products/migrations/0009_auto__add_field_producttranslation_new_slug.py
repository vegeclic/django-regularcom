...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('products_product_translation', 'new_slug',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('products_product_translation', 'new_slug')
    ...
    models = {
        ...
        'products.product': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['products.Category']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'null': 'True', 'related_name': "'+'", 'blank': 'True', 'unique': 'True'}),
            'products_parent': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'related_name': "'products_children'", 'blank': 'True', 'to': "orm['products.Product']"}),
