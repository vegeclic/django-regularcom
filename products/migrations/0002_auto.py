...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field categories on 'Category'
        m2m_table_name = db.shorten_name('products_category_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_category', models.ForeignKey(orm['products.category'], null=False)),
            ('to_category', models.ForeignKey(orm['products.category'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_category_id', 'to_category_id'])


    def backwards(self, orm):
        # Removing M2M table for field categories on 'Category'
        db.delete_table(db.shorten_name('products_category_categories'))
