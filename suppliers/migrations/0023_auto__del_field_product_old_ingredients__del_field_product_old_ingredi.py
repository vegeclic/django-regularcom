...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('suppliers_product', 'old_ingredients', 'brut_ingredients')
        db.rename_column('suppliers_product', 'old_ingredients_fr', 'brut_ingredients_fr')
        db.rename_column('suppliers_product', 'old_ingredients_de', 'brut_ingredients_de')

    def backwards(self, orm):
        db.rename_column('suppliers_product', 'brut_ingredients', 'old_ingredients')
        db.rename_column('suppliers_product', 'brut_ingredients_fr', 'old_ingredients_fr')
        db.rename_column('suppliers_product', 'brut_ingredients_de', 'old_ingredients_de')
    ...
    models = {
        ...
        'products.product': {
            ...
            'tax': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_price_tax'", 'to': "orm['suppliers.Tax']", 'blank': 'True', 'null': 'True'})
        },
        'products.taggeditem': {
        ...
        'suppliers.energy': {
            ...
            'name_de': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'suppliers.energyextent': {
            ...
            'energy': ('django.db.models.fields.related.ForeignKey', [], {'unique': 'True', 'to': "orm['suppliers.Energy']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'suppliers.ingredientextent': {
            ...
            'ingredient_parent': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'ingredient_children'", 'to': "orm['suppliers.IngredientExtent']", 'blank': 'True', 'null': 'True'})
        },
        'suppliers.inventory': {
        ...
        'suppliers.price': {
            ...
            'tax': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'supplier_product_price_tax'", 'to': "orm['suppliers.Tax']", 'blank': 'True', 'null': 'True'})
        },
        'suppliers.product': {
            'Meta': {'object_name': 'Product'},
            'allergies': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'product_allergies'", 'to': "orm['suppliers.Ingredient']", 'blank': 'True', 'null': 'True'}),
            'body': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'body_de': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True'}),
            'body_fr': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'to': "orm['common.Image']", 'blank': 'True', 'null': 'True'}),
            'main_price': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'unique': 'True', 'to': "orm['suppliers.Price']", 'blank': 'True', 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'name_de': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True', 'null': 'True'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True', 'null': 'True'}),
            ...
            'traces': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'product_traces'", 'to': "orm['suppliers.Ingredient']", 'blank': 'True', 'null': 'True'}),
