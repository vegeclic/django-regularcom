...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('suppliers_product', 'name_de',
                      self.gf('django.db.models.fields.CharField')(null=True, max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Product.name_fr'
        db.add_column('suppliers_product', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(null=True, max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Product.slug_de'
        db.add_column('suppliers_product', 'slug_de',
                      self.gf('django.db.models.fields.SlugField')(null=True, max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Product.slug_fr'
        db.add_column('suppliers_product', 'slug_fr',
                      self.gf('django.db.models.fields.SlugField')(null=True, max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Product.body_de'
        db.add_column('suppliers_product', 'body_de',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.body_fr'
        db.add_column('suppliers_product', 'body_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.ingredients_de'
        db.add_column('suppliers_product', 'ingredients_de',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.ingredients_fr'
        db.add_column('suppliers_product', 'ingredients_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('suppliers_product', 'name_de')

        # Deleting field 'Product.name_fr'
        db.delete_column('suppliers_product', 'name_fr')

        # Deleting field 'Product.slug_de'
        db.delete_column('suppliers_product', 'slug_de')

        # Deleting field 'Product.slug_fr'
        db.delete_column('suppliers_product', 'slug_fr')

        # Deleting field 'Product.body_de'
        db.delete_column('suppliers_product', 'body_de')

        # Deleting field 'Product.body_fr'
        db.delete_column('suppliers_product', 'body_fr')

        # Deleting field 'Product.ingredients_de'
        db.delete_column('suppliers_product', 'ingredients_de')

        # Deleting field 'Product.ingredients_fr'
        db.delete_column('suppliers_product', 'ingredients_fr')
