...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('suppliers', ['Tax'])

        # Deleting field 'Price.fee'
        db.delete_column('suppliers_price', 'fee_id')

        # Adding field 'Price.tax'
        db.add_column('suppliers_price', 'tax',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='supplier_product_price_tax', null=True, to=orm['suppliers.Tax'], blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Tax'
        db.delete_table('suppliers_tax')

        # Adding field 'Price.fee'
        db.add_column('suppliers_price', 'fee',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='supplier_product_price_fee', null=True, to=orm['suppliers.Fee'], blank=True),
                      keep_default=False)

        # Deleting field 'Price.tax'
        db.delete_column('suppliers_price', 'tax_id')
