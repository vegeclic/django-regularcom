...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductTranslation.new_slug'
        db.add_column('suppliers_product_translation', 'new_slug',
                      self.gf('django.db.models.fields.SlugField')(blank=True, null=True, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductTranslation.new_slug'
        db.delete_column('suppliers_product_translation', 'new_slug')
    ...
    models = {
        ...
        'accounts.author': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'unique': 'True', 'to': "orm['common.Image']"}),
        ...
        'suppliers.price': {
            ...
            'tax': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'supplier_product_price_tax'", 'null': 'True', 'to': "orm['suppliers.Tax']"})
        },
        'suppliers.product': {
            'Meta': {'object_name': 'Product'},
        ...
        'suppliers.producttranslation': {
            ...
            'new_slug': ('django.db.models.fields.SlugField', [], {'blank': 'True', 'null': 'True', 'max_length': '100'})
        },
        'suppliers.store': {
