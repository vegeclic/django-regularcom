...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.newsletter'
        db.add_column('accounts_account', 'newsletter',
                      self.gf('django.db.models.fields.CharField')(max_length=1, default='i'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.newsletter'
        db.delete_column('accounts_account', 'newsletter')
    ...
    models = {
        'accounts.account': {
            ...
            'newsletter': ('django.db.models.fields.CharField', [], {'max_length': '1', 'default': "'i'"}),
