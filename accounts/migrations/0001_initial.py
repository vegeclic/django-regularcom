...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Author'
        db.create_table('accounts_author', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.Account'], unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(blank=True, max_length=30)),
            ('main_image', self.gf('django.db.models.fields.related.OneToOneField')(null=True, blank=True, to=orm['common.Image'], unique=True, related_name='+')),
        ))
        db.send_create_signal('accounts', ['Author'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accounts_author')
