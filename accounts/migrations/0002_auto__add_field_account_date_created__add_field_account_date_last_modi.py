...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.date_last_modified'
        db.add_column('accounts_account', 'date_last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True, default=datetime.datetime(2013, 10, 28, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Account.date_last_modified'
        db.delete_column('accounts_account', 'date_last_modified')
