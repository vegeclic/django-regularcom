...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Criteria.name_de'
        db.add_column('common_criteria', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=100, blank=True, null=True),
                      keep_default=False)

        # Adding field 'Criteria.name_fr'
        db.add_column('common_criteria', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=100, blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Criteria.name_de'
        db.delete_column('common_criteria', 'name_de')

        # Deleting field 'Criteria.name_fr'
        db.delete_column('common_criteria', 'name_fr')
    ...
    models = {
        ...
        'common.criteriatranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'CriteriaTranslation', 'db_table': "'common_criteria_translation'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'to': "orm['common.Criteria']", 'null': 'True'}),
