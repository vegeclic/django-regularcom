...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CriteriaTranslation'
        db.create_table('common_criteria_translation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('language_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=15)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Criteria'], null=True, related_name='translations')),
        ))
        db.send_create_signal('common', ['CriteriaTranslation'])

        # Adding unique constraint on 'CriteriaTranslation', fields ['language_code', 'master']
        db.create_unique('common_criteria_translation', ['language_code', 'master_id'])

        # Deleting field 'Criteria.name'
        db.delete_column('common_criteria', 'name')


    def backwards(self, orm):
        # Removing unique constraint on 'CriteriaTranslation', fields ['language_code', 'master']
        db.delete_unique('common_criteria_translation', ['language_code', 'master_id'])

        # Deleting model 'CriteriaTranslation'
        db.delete_table('common_criteria_translation')

        # Adding field 'Criteria.name'
        db.add_column('common_criteria', 'name',
                      self.gf('django.db.models.fields.CharField')(unique=True, default='', max_length=100),
                      keep_default=False)
    ...
    models = {
        ...
        'common.criteriatranslation': {
            'Meta': {'db_table': "'common_criteria_translation'", 'unique_together': "[('language_code', 'master')]", 'object_name': 'CriteriaTranslation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '15'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.Criteria']", 'null': 'True', 'related_name': "'translations'"}),
