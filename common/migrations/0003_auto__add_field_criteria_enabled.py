...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Criteria.enabled'
        db.add_column('common_criteria', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Criteria.enabled'
        db.delete_column('common_criteria', 'enabled')
    ...
    models = {
        ...
        'common.criteriatranslation': {
            'Meta': {'object_name': 'CriteriaTranslation', 'unique_together': "[('language_code', 'master')]", 'db_table': "'common_criteria_translation'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '15'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': "orm['common.Criteria']"}),
