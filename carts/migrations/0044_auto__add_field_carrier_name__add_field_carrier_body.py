...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Carrier.name'
        db.add_column('carts_carrier', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Carrier.body'
        db.add_column('carts_carrier', 'body',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Carrier.name'
        db.delete_column('carts_carrier', 'name')

        # Deleting field 'Carrier.body'
        db.delete_column('carts_carrier', 'body')
    ...
    models = {
        ...
        'customers.customer': {
            ...
            'relay_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['common.Address']"}),
