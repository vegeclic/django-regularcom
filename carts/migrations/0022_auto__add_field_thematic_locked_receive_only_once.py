...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thematic.locked_receive_only_once'
        db.add_column('carts_thematic', 'locked_receive_only_once',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thematic.locked_receive_only_once'
        db.delete_column('carts_thematic', 'locked_receive_only_once')
    ...
    models = {
        ...
        'carts.subscription': {
            ...
            'carrier': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['carts.Carrier']"}),
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['common.Criteria']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'cart_subscription_criterias'"}),
        ...
        'carts.thematic': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['common.Criteria']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'thematic_criterias'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'customers.customer': {
            ...
            'account': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'to': "orm['accounts.Account']"}),
            'billing_address': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'blank': 'True', 'unique': 'True', 'to': "orm['common.Address']", 'related_name': "'+'"}),
            'date_of_birth': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_address': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'blank': 'True', 'unique': 'True', 'to': "orm['common.Address']", 'related_name': "'+'"}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'blank': 'True', 'unique': 'True', 'to': "orm['common.Image']", 'related_name': "'+'"}),
            'shipping_address': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'blank': 'True', 'unique': 'True', 'to': "orm['common.Address']", 'related_name': "'+'"})
        },
        'products.category': {
        ...
        'products.product': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['products.Category']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'+'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'blank': 'True', 'unique': 'True', 'to': "orm['common.Image']", 'related_name': "'+'"}),
            'products_parent': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['products.Product']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'products_children'"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'unique': 'True'}),
        ...
        'suppliers.product': {
            'Meta': {'object_name': 'Product'},
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['common.Criteria']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'product_criterias'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'blank': 'True', 'unique': 'True', 'to': "orm['common.Image']", 'related_name': "'+'"}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '1', 'default': "'d'"}),
            'suppliers': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['suppliers.Supplier']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'product_suppliers'"}),
