...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtentContent'
        db.create_table('carts_extentcontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('extent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carts.Extent'])),
        ))
        db.send_create_signal('carts', ['ExtentContent'])

        # Adding model 'ExtentContentProduct'
        db.create_table('carts_extentcontentproduct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carts.ExtentContent'])),
        ...
        db.send_create_signal('carts', ['ExtentContentProduct'])

        # Adding unique constraint on 'ExtentContentProduct', fields ['content', 'product']
        db.create_unique('carts_extentcontentproduct', ['content_id', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ExtentContentProduct', fields ['content', 'product']
        db.delete_unique('carts_extentcontentproduct', ['content_id', 'product_id'])

        # Deleting model 'ExtentContent'
        db.delete_table('carts_extentcontent')

        # Deleting model 'ExtentContentProduct'
        db.delete_table('carts_extentcontentproduct')
    ...
    models = {
        ...
        'accounts.author': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'unique': 'True', 'blank': 'True', 'null': 'True', 'related_name': "'+'"}),
        ...
        'carts.subscription': {
            ...
            'carrier': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['carts.Carrier']"}),
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.Criteria']", 'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'related_name': "'cart_subscription_criterias'"}),
        ...
        'carts.thematic': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.Criteria']", 'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'related_name': "'thematic_criterias'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'customers.customer': {
            ...
            'account': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['accounts.Account']", 'unique': 'True'}),
            'billing_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'unique': 'True', 'blank': 'True', 'null': 'True', 'related_name': "'+'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'date_of_birth': ('django.db.models.fields.DateField', [], {'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'unique': 'True', 'blank': 'True', 'null': 'True', 'related_name': "'+'"}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'unique': 'True', 'blank': 'True', 'null': 'True', 'related_name': "'+'"}),
            'pro': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'relay_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'unique': 'True', 'blank': 'True', 'null': 'True', 'related_name': "'+'"}),
            'shipping_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'unique': 'True', 'blank': 'True', 'null': 'True', 'related_name': "'+'"})
        },
        'products.category': {
        ...
        'products.product': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['products.Category']", 'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'related_name': "'+'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'unique': 'True', 'blank': 'True', 'null': 'True', 'related_name': "'+'"}),
            'products_parent': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['products.Product']", 'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'related_name': "'products_children'"}),
        ...
        'suppliers.product': {
            'Meta': {'object_name': 'Product'},
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.Criteria']", 'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'related_name': "'product_criterias'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'unique': 'True', 'blank': 'True', 'null': 'True', 'related_name': "'+'"}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'d'", 'max_length': '1'}),
            'suppliers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['suppliers.Supplier']", 'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'related_name': "'product_suppliers'"}),
