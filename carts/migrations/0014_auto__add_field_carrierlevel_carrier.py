...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CarrierLevel.carrier'
        db.add_column('carts_carrierlevel', 'carrier',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carts.Carrier'], default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CarrierLevel.carrier'
        db.delete_column('carts_carrierlevel', 'carrier_id')
    ...
    models = {
        ...
        'accounts.author': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'unique': 'True'}),
        ...
        'carts.subscription': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.Criteria']", 'related_name': "'cart_subscription_criterias'", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
        ...
        'carts.thematic': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.Criteria']", 'related_name': "'thematic_criterias'", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'customers.customer': {
            ...
            'account': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['accounts.Account']", 'unique': 'True'}),
            'billing_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'unique': 'True'}),
            'date_of_birth': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'unique': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'unique': 'True'}),
            'shipping_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'unique': 'True'})
        },
        'products.category': {
        ...
        'products.product': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['products.Category']", 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'unique': 'True'}),
            'products_parent': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['products.Product']", 'related_name': "'products_children'", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'unique': 'True'}),
        ...
        'suppliers.product': {
            'Meta': {'object_name': 'Product'},
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.Criteria']", 'related_name': "'product_criterias'", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'related_name': "'+'", 'null': 'True', 'blank': 'True', 'unique': 'True'}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '1', 'default': "'d'"}),
            'suppliers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['suppliers.Supplier']", 'related_name': "'product_suppliers'", 'null': 'True', 'blank': 'True', 'symmetrical': 'False'}),
