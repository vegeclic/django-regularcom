...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('carts_carrier_translation', (
            ...
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carts.Carrier'], null=True, related_name='translations')),
    ...
    models = {
        ...
        'customers.customer': {
            ...
            'relay_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'blank': 'True', 'null': 'True', 'to': "orm['common.Address']", 'related_name': "'+'"}),
