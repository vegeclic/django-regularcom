...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for s in orm.SizeTranslation.objects.all():
            s.master.__dict__['name_%s' % s.language_code] = s.old_name
            s.master.__dict__['body_%s' % s.language_code] = s.old_body
            s.master.save()
    ...
    def backwards(self, orm):
        ...
        for s in orm.SizeTranslation.objects.all():
            s.old_name = s.master.__dict__.get('name_%s' % s.language_code, '')
            s.old_body = s.master.__dict__.get('body_%s' % s.language_code, '')
            s.save()
    ...
    models = {
        ...
        'accounts.author': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['common.Image']", 'related_name': "'+'", 'blank': 'True'}),
        ...
        'customers.customer': {
            ...
            'account': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'to': "orm['accounts.Account']"}),
            'billing_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['common.Address']", 'related_name': "'+'", 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'date_of_birth': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['common.Address']", 'related_name': "'+'", 'blank': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['common.Image']", 'related_name': "'+'", 'blank': 'True'}),
            'pro': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'relay_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['common.Address']", 'related_name': "'+'", 'blank': 'True'}),
            'shipping_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['common.Address']", 'related_name': "'+'", 'blank': 'True'})
        },
        'products.category': {
