...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('carts_subscription', 'status')

        # Adding field 'Subscription.enabled'
        db.add_column('carts_subscription', 'enabled',
    ...
    models = {
        ...
        'carts.thematic': {
            ...
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'blank': 'True', 'related_name': "'+'", 'null': 'True', 'unique': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['products.Product']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'thematic_products'", 'null': 'True'}),
