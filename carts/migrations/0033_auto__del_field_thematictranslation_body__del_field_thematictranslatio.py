...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('carts_thematic_translation', 'body', 'old_body')
        db.rename_column('carts_thematic_translation', 'name', 'old_name')

    def backwards(self, orm):
        # Adding field 'ThematicTranslation.body'
        db.add_column('carts_thematic_translation', 'body',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ThematicTranslation.name'
        db.add_column('carts_thematic_translation', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, default='', unique=True),
                      keep_default=False)

        # Deleting field 'ThematicTranslation.old_name'
        db.delete_column('carts_thematic_translation', 'old_name')

        # Deleting field 'ThematicTranslation.old_body'
        db.delete_column('carts_thematic_translation', 'old_body')
    ...
    models = {
        ...
        'accounts.author': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'to': "orm['common.Image']", 'unique': 'True', 'related_name': "'+'", 'blank': 'True'}),
        ...
        'carts.subscription': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['common.Criteria']", 'symmetrical': 'False', 'related_name': "'cart_subscription_criterias'", 'blank': 'True'}),
        ...
        'carts.thematic': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['common.Criteria']", 'symmetrical': 'False', 'related_name': "'thematic_criterias'", 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'customers.customer': {
            ...
            'account': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'to': "orm['accounts.Account']"}),
            'billing_address': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'to': "orm['common.Address']", 'unique': 'True', 'related_name': "'+'", 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'date_of_birth': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_address': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'to': "orm['common.Address']", 'unique': 'True', 'related_name': "'+'", 'blank': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'to': "orm['common.Image']", 'unique': 'True', 'related_name': "'+'", 'blank': 'True'}),
            'pro': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'relay_address': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'to': "orm['common.Address']", 'unique': 'True', 'related_name': "'+'", 'blank': 'True'}),
            'shipping_address': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'to': "orm['common.Address']", 'unique': 'True', 'related_name': "'+'", 'blank': 'True'})
        },
        'products.category': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['products.Category']", 'related_name': "'categories_rel_+'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'to': "orm['common.Image']", 'unique': 'True', 'related_name': "'+'", 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'products.product': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['products.Category']", 'symmetrical': 'False', 'related_name': "'+'", 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'to': "orm['common.Image']", 'unique': 'True', 'related_name': "'+'", 'blank': 'True'}),
            ...
            'name_de': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
            'products_parent': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['products.Product']", 'symmetrical': 'False', 'related_name': "'products_children'", 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'null': 'True', 'blank': 'True', 'max_length': '50'}),
        ...
        'suppliers.product': {
            ...
            'body_de': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'body_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['common.Criteria']", 'symmetrical': 'False', 'related_name': "'product_criterias'", 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '1', 'default': "'d'"}),
            'suppliers': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['suppliers.Supplier']", 'symmetrical': 'False', 'related_name': "'product_suppliers'", 'blank': 'True'}),
        ...
        'suppliers.supplier': {
            ...
            'suppliers': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['suppliers.Supplier']", 'related_name': "'suppliers_rel_+'", 'blank': 'True'}),
