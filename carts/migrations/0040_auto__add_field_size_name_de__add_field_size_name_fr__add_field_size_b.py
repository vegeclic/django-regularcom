...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Size.name_de'
        db.add_column('carts_size', 'name_de',
                      self.gf('django.db.models.fields.CharField')(blank=True, null=True, max_length=100),
                      keep_default=False)

        # Adding field 'Size.name_fr'
        db.add_column('carts_size', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(blank=True, null=True, max_length=100),
                      keep_default=False)

        # Adding field 'Size.body_de'
        db.add_column('carts_size', 'body_de',
                      self.gf('django.db.models.fields.TextField')(blank=True, null=True),
                      keep_default=False)

        # Adding field 'Size.body_fr'
        db.add_column('carts_size', 'body_fr',
                      self.gf('django.db.models.fields.TextField')(blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Size.name_de'
        db.delete_column('carts_size', 'name_de')

        # Deleting field 'Size.name_fr'
        db.delete_column('carts_size', 'name_fr')

        # Deleting field 'Size.body_de'
        db.delete_column('carts_size', 'body_de')

        # Deleting field 'Size.body_fr'
        db.delete_column('carts_size', 'body_fr')
    ...
    models = {
        ...
        'carts.subscription': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.Criteria']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'cart_subscription_criterias'", 'null': 'True'}),
        ...
        'carts.thematic': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.Criteria']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'thematic_criterias'", 'null': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'customers.customer': {
            ...
            'account': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['accounts.Account']", 'unique': 'True'}),
            'billing_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'blank': 'True', 'related_name': "'+'", 'null': 'True', 'unique': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'date_of_birth': ('django.db.models.fields.DateField', [], {'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'blank': 'True', 'related_name': "'+'", 'null': 'True', 'unique': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'blank': 'True', 'related_name': "'+'", 'null': 'True', 'unique': 'True'}),
            'pro': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'relay_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'blank': 'True', 'related_name': "'+'", 'null': 'True', 'unique': 'True'}),
            'shipping_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'blank': 'True', 'related_name': "'+'", 'null': 'True', 'unique': 'True'})
        },
        'products.category': {
        ...
        'products.product': {
            ...
            'name_de': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '100'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '100'}),
            'products_parent': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['products.Product']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'products_children'", 'null': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'blank': 'True', 'null': 'True', 'max_length': '50'}),
        ...
        'suppliers.product': {
            ...
            'body_de': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True'}),
            'body_fr': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True'}),
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['common.Criteria']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'product_criterias'", 'null': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'d'", 'max_length': '1'}),
            'suppliers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['suppliers.Supplier']", 'symmetrical': 'False', 'blank': 'True', 'related_name': "'product_suppliers'", 'null': 'True'}),
