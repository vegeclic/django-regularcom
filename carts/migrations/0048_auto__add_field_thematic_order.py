...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thematic.order'
        db.add_column('carts_thematic', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thematic.order'
        db.delete_column('carts_thematic', 'order')
    ...
    models = {
        ...
        'accounts.author': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['common.Image']", 'blank': 'True', 'unique': 'True'}),
        ...
        'carts.subscription': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['common.Criteria']", 'blank': 'True', 'related_name': "'cart_subscription_criterias'"}),
        ...
        'carts.thematic': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['common.Criteria']", 'blank': 'True', 'related_name': "'thematic_criterias'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'customers.customer': {
            ...
            'account': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['accounts.Account']", 'unique': 'True'}),
            'billing_address': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'customer_billing_address'", 'null': 'True', 'to': "orm['common.Address']", 'blank': 'True', 'unique': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'date_of_birth': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_address': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'customer_main_address'", 'null': 'True', 'to': "orm['common.Address']", 'blank': 'True', 'unique': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'customer_main_image'", 'null': 'True', 'to': "orm['common.Image']", 'blank': 'True', 'unique': 'True'}),
            'pro': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'relay_address': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'customer_relay_address'", 'null': 'True', 'to': "orm['common.Address']", 'blank': 'True', 'unique': 'True'}),
            'shipping_address': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'customer_shipping_address'", 'null': 'True', 'to': "orm['common.Address']", 'blank': 'True', 'unique': 'True'})
        },
        'products.category': {
            'Meta': {'object_name': 'Category'},
            'authors': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'blank': 'True', 'to': "orm['accounts.Author']"}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['products.Category']", 'blank': 'True', 'related_name': "'categories_rel_+'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['common.Image']", 'blank': 'True', 'unique': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'name_de': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
        ...
        'products.product': {
            ...
            'body_de': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'body_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['products.Category']", 'blank': 'True', 'related_name': "'+'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['common.Image']", 'blank': 'True', 'unique': 'True'}),
            ...
            'name_de': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
            'products_parent': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['products.Product']", 'blank': 'True', 'related_name': "'products_children'"}),
            'slug': ('django.db.models.fields.SlugField', [], {'null': 'True', 'blank': 'True', 'max_length': '50'}),
            ...
            'tax': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'product_price_tax'", 'blank': 'True', 'to': "orm['suppliers.Tax']"})
        },
        'suppliers.ingredient': {
            'Meta': {'object_name': 'Ingredient'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True'}),
            'name_de': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '100', 'blank': 'True', 'unique': 'True'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '100', 'blank': 'True', 'unique': 'True'})
        },
        'suppliers.price': {
            ...
            'tax': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'supplier_product_price_tax'", 'blank': 'True', 'to': "orm['suppliers.Tax']"})
        },
        'suppliers.product': {
            'Meta': {'object_name': 'Product'},
            'allergies': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['suppliers.Ingredient']", 'blank': 'True', 'related_name': "'product_allergies'"}),
            'body': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'body_de': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'body_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'brut_ingredients': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'brut_ingredients_de': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'brut_ingredients_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['common.Criteria']", 'blank': 'True', 'related_name': "'product_criterias'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['common.Image']", 'blank': 'True', 'unique': 'True'}),
            'main_price': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['suppliers.Price']", 'blank': 'True', 'unique': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'name_de': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '1', 'default': "'d'"}),
            'suppliers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['suppliers.Supplier']", 'blank': 'True', 'related_name': "'product_suppliers'"}),
            'traces': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['suppliers.Ingredient']", 'blank': 'True', 'related_name': "'product_traces'"}),
        ...
        'suppliers.supplier': {
            ...
            'suppliers': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['suppliers.Supplier']", 'blank': 'True', 'related_name': "'suppliers_rel_+'"}),
