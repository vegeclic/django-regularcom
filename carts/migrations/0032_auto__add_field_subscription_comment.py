...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('carts_subscription', 'comment',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('carts_subscription', 'comment')
    ...
    models = {
        ...
        'customers.customer': {
            ...
            'account': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['accounts.Account']", 'unique': 'True'}),
            'billing_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'related_name': "'+'", 'blank': 'True', 'null': 'True', 'unique': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'date_of_birth': ('django.db.models.fields.DateField', [], {'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'related_name': "'+'", 'blank': 'True', 'null': 'True', 'unique': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'related_name': "'+'", 'blank': 'True', 'null': 'True', 'unique': 'True'}),
            'pro': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'relay_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'related_name': "'+'", 'blank': 'True', 'null': 'True', 'unique': 'True'}),
            'shipping_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'related_name': "'+'", 'blank': 'True', 'null': 'True', 'unique': 'True'})
        },
        'products.category': {
