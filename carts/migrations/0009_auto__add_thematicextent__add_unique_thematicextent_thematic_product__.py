...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ThematicExtent'
        db.create_table('carts_thematicextent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('thematic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carts.Thematic'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Product'])),
            ('extent', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('carts', ['ThematicExtent'])

        # Adding unique constraint on 'ThematicExtent', fields ['thematic', 'product']
        db.create_unique('carts_thematicextent', ['thematic_id', 'product_id'])


        # Changing field 'Thematic.start_period'
        db.alter_column('carts_thematic', 'start_period', self.gf('django.db.models.fields.CharField')(null=True, max_length=10))

    def backwards(self, orm):
        # Removing unique constraint on 'ThematicExtent', fields ['thematic', 'product']
        db.delete_unique('carts_thematicextent', ['thematic_id', 'product_id'])

        # Deleting model 'ThematicExtent'
        db.delete_table('carts_thematicextent')
    ...
    models = {
        ...
        'carts.subscription': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'cart_subscription_criterias'", 'symmetrical': 'False', 'to': "orm['common.Criteria']", 'blank': 'True'}),
        ...
        'carts.thematic': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'thematic_criterias'", 'symmetrical': 'False', 'to': "orm['common.Criteria']", 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'suppliers.product': {
            'Meta': {'object_name': 'Product'},
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'product_criterias'", 'symmetrical': 'False', 'to': "orm['common.Criteria']", 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'related_name': "'+'", 'to': "orm['common.Image']", 'blank': 'True'}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '1', 'default': "'d'"}),
            'suppliers': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'product_suppliers'", 'symmetrical': 'False', 'to': "orm['suppliers.Supplier']", 'blank': 'True'}),
