...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ExtentContent', fields ['extent']
        db.create_unique('carts_extentcontent', ['extent_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ExtentContent', fields ['extent']
        db.delete_unique('carts_extentcontent', ['extent_id'])
    ...
    models = {
        ...
        'customers.customer': {
            ...
            'relay_address': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'related_name': "'+'", 'unique': 'True', 'blank': 'True', 'to': "orm['common.Address']"}),
