...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thematic.name_de'
        db.add_column('carts_thematic', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=100, blank=True, null=True),
                      keep_default=False)

        # Adding field 'Thematic.name_fr'
        db.add_column('carts_thematic', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=100, blank=True, null=True),
                      keep_default=False)

        # Adding field 'Thematic.body_de'
        db.add_column('carts_thematic', 'body_de',
                      self.gf('django.db.models.fields.TextField')(blank=True, null=True),
                      keep_default=False)

        # Adding field 'Thematic.body_fr'
        db.add_column('carts_thematic', 'body_fr',
                      self.gf('django.db.models.fields.TextField')(blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thematic.name_de'
        db.delete_column('carts_thematic', 'name_de')

        # Deleting field 'Thematic.name_fr'
        db.delete_column('carts_thematic', 'name_fr')

        # Deleting field 'Thematic.body_de'
        db.delete_column('carts_thematic', 'body_de')

        # Deleting field 'Thematic.body_fr'
        db.delete_column('carts_thematic', 'body_fr')
    ...
    models = {
        ...
        'customers.customer': {
            ...
            'relay_address': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Address']", 'blank': 'True', 'null': 'True', 'related_name': "'+'", 'unique': 'True'}),
