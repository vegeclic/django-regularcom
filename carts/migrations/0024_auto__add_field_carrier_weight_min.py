...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Carrier.weight_min'
        db.add_column('carts_carrier', 'weight_min',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Carrier.weight_min'
        db.delete_column('carts_carrier', 'weight_min')
    ...
    models = {
        ...
        'carts.subscription': {
            ...
            'carrier': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['carts.Carrier']"}),
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'cart_subscription_criterias'", 'symmetrical': 'False', 'null': 'True', 'to': "orm['common.Criteria']", 'blank': 'True'}),
        ...
        'carts.thematic': {
            ...
            'criterias': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'thematic_criterias'", 'symmetrical': 'False', 'null': 'True', 'to': "orm['common.Criteria']", 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
