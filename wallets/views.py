...
class CreditRequestView(generic.ListView):
    ...
    @method_decorator(login_required)
    def dispatch(self, *args, **kwargs):
        return super(CreditRequestView, self).dispatch(*args, **kwargs)
...
class WithdrawRequestView(generic.ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(WithdrawRequestView, self).get_context_data(**kwargs)
        context['section'] = 'wallet'
    ...
    @method_decorator(login_required)
    def dispatch(self, *args, **kwargs):
        return super(WithdrawRequestView, self).dispatch(*args, **kwargs)
...
class CreditView(generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        return super(CreditView, self).form_valid(form)
...
class WithdrawView(generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        try:
            response = super(WithdrawView, self).form_valid(form)
...
class WithdrawCancelView(generic.View):
    ...
    @method_decorator(login_required)
    def dispatch(self, *args, **kwargs):
        return super(WithdrawCancelView, self).dispatch(*args, **kwargs)
...
class CreditCancelView(generic.View):
    ...
    @method_decorator(login_required)
    def dispatch(self, *args, **kwargs):
        return super(CreditCancelView, self).dispatch(*args, **kwargs)
