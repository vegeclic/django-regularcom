...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Withdraw'
        db.create_table('wallets_withdraw', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wallet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wallets.Wallet'])),
            ('payment_type', self.gf('django.db.models.fields.CharField')(max_length=1, default='c')),
        ...
        db.send_create_signal('wallets', ['Withdraw'])


    def backwards(self, orm):
        # Deleting model 'Withdraw'
        db.delete_table('wallets_withdraw')
    ...
    models = {
        ...
        'customers.customer': {
            ...
            'billing_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['common.Address']", 'blank': 'True', 'related_name': "'+'"}),
            'date_of_birth': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['common.Address']", 'blank': 'True', 'related_name': "'+'"}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['common.Image']", 'blank': 'True', 'related_name': "'+'"}),
            'shipping_address': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['common.Address']", 'blank': 'True', 'related_name': "'+'"})
        },
        'wallets.credit': {
