...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('blog_article_translation', (
            ...
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['blog.Article'])),
            ('language_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=15)),
            ('old_title', self.gf('django.db.models.fields.CharField')(max_length=200)),
    ...
    models = {
        ...
        'blog.article': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'blog_article_categories'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['blog.Category']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'blank': 'True', 'related_name': "'blog_article_main_image'", 'null': 'True', 'to': "orm['common.Image']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200'}),
            'thumb_image': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'blank': 'True', 'related_name': "'blog_article_thumb_image'", 'null': 'True', 'to': "orm['common.Image']"}),
            ...
            'title_image': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'blank': 'True', 'related_name': "'blog_article_title_image'", 'null': 'True', 'to': "orm['common.Image']"})
        },
        'blog.category': {
