...
class Migration(DataMigration):
    ...
    models = {
        ...
        'accounts.author': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'related_name': "'+'", 'blank': 'True', 'to': "orm['common.Image']", 'unique': 'True'}),
        ...
        'blog.article': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'symmetrical': 'False', 'to': "orm['blog.Category']", 'blank': 'True', 'related_name': "'blog_article_categories'"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'related_name': "'blog_article_main_image'", 'blank': 'True', 'to': "orm['common.Image']", 'unique': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200'}),
            'thumb_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'related_name': "'blog_article_thumb_image'", 'blank': 'True', 'to': "orm['common.Image']", 'unique': 'True'}),
            ...
            'title_image': ('django.db.models.fields.related.OneToOneField', [], {'null': 'True', 'related_name': "'blog_article_title_image'", 'blank': 'True', 'to': "orm['common.Image']", 'unique': 'True'})
        },
        'blog.category': {
        ...
        'blog.categorytranslation': {
            'Meta': {'object_name': 'CategoryTranslation', 'db_table': "'blog_category_translation'", 'unique_together': "[('language_code', 'master')]"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
