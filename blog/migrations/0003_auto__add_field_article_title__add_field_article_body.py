...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'blog.article': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'blog_article_categories'", 'null': 'True', 'blank': 'True', 'symmetrical': 'False', 'to': "orm['blog.Category']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'blog_article_main_image'", 'null': 'True', 'blank': 'True', 'unique': 'True', 'to': "orm['common.Image']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200'}),
            'thumb_image': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'blog_article_thumb_image'", 'null': 'True', 'blank': 'True', 'unique': 'True', 'to': "orm['common.Image']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'title_image': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'blog_article_title_image'", 'null': 'True', 'blank': 'True', 'unique': 'True', 'to': "orm['common.Image']"})
        },
        'blog.articletranslation': {
            ...
            'master': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Article']", 'null': 'True', 'related_name': "'translations'"}),
        ...
        'blog.categorytranslation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Category']", 'null': 'True', 'related_name': "'translations'"}),
