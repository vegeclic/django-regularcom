...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_article', (
            ...
            ('main_image', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['common.Image'], related_name='blog_article_main_image', unique=True, null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'blog.article': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Image']", 'related_name': "'blog_article_main_image'", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
